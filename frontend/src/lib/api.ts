...
// ─── NEPSE Broker Number → Name Mapping ────────────────────────────────────
export const BROKER_MAP: Record<number, string> = {
  1:  "Kumari Securities",
  3:  "Arun Securities",
  4:  "Opal Securities",
  5:  "Market Securities",
  ...
  11: "Malla & Malla Stock Broking",
  13: "Thrive Securities",
  14: "Nepal Stock House",
  16: "Primo Securities",
  17: "ABC Securities",
  18: "Sagarmatha Securities",
  19: "Swostik Securities",
  20: "Siddhartha Securities",
  21: "Sipla Securities",
  22: "Ace Securities",
  23: "Sunrise Securities",
  24: "Progressive Securities",
  25: "Online Securities",
  26: "Kalika Securities",
  27: "Imperial Securities",
  28: "Sewa Securities",
  29: "Shivam Securities",
  30: "Annapurna Securities",
  31: "Kasthamandap Securities",
  32: "Creative Securities",
  33: "National Securities",
  34: "Standard Securities",
  35: "Himalayan Securities",
  36: "Pokhara Finance Securities",
  37: "Stock Broker 37",
  38: "B&A Securities",
  39: "Midas Securities",
  40: "Nepal Financial Markets",
  41: "Gorkha Securities",
  42: "Beed Investment",
  43: "Vision Securities",
  44: "Sovereign Securities",
  45: "Axis Securities",
  46: "Capital Investment",
  47: "Shree Krishna Securities",
  48: "Classic Plus Securities",
  49: "Nepal Equity Research",
  50: "Zenith Finance Securities",
  51: "Lalitpur Finance Securities",
  52: "NMB Securities",
  53: "City Securities",
  54: "Trishakti Securities",
  55: "Prabhu Securities",
  56: "Global IME Securities",
  57: "Elite Capital Markets",
  58: "Naasa Securities",
  59: "Swarnalakshmi Securities",
  60: "Vijaya Securities",
  61: "Upkar Securities",
  62: "Nabil Investment Banking",
  63: "Sunrise Capital",
  64: "Sanima Capital",
  65: "Nepal Investment Merchant Bank",
  66: "NIBL Ace Capital",
  67: "Laxmi Capital",
  68: "Mega Capital Markets",
  69: "RBBL Securities",
  70: "Century Commercial Capital",
  71: "Siddhartha Capital",
  72: "Civil Capital Market",
  73: "Muktinath Capital",
  74: "Jyoti Capital Markets",
  75: "Machhapuchchhre Capital",
  76: "Citizen Capital Market",
  77: "Nepal Life Capital Markets",
  78: "Guardian Capital",
  79: "Goodwill Capital",
  80: "AIS Securities",
  81: "Prabhu Capital",
  82: "NIC Asia Capital",
  83: "Himalayan Capital",
  84: "Shikhar Securities",
  85: "BN Securities",
  86: "Aayush Securities",
  87: "New IT Securities",
  88: "Vision Capital Markets",
  89: "Shubha Securities",
  90: "Karnali Capital",
  91: "Western Securities",
  92: "Everest Securities",
};

/** Returns the broker name for a given broker number, or a fallback string. */
export function getBrokerName(brokerNo: number): string {
  return BROKER_MAP[brokerNo] ?? `Broker #${brokerNo}`;
}
